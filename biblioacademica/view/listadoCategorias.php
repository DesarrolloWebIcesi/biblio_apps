...
<script type="text/javascript" src="<?php echo $GLOBALS["app_route"] ?>/js/lcategorias_validations.js" charset="iso-8859-1"></script>
<div id="dataarea">
    <table>
        <tr>
            <td>
                <div id="selectedarea">
                    Resultados para <strong><?php echo $_SESSION['parea_desc']; ?></strong>
                </div>
            </td>
            <td><div id="backarea">Seleccionar otra &Aacute;rea</div>
    </table>
</div>
<div id="app_content">
    ...
    <div id="cestudio">
        <div class="title"><h4>Resultados de Casos de estudio</h4></div>
        <div id="app_info">
            <span>
            </span>
        </div>
    ...
    <div id="mapas">
        <div class="title"><h4>Resultados en Mapas</h4></div>
        <div id="app_info">
            <span>
            </span>
        </div>
