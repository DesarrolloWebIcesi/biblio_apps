...
session_start();
$url_content = $GLOBALS["app_route"].'/ajaxview/htmlMapas.php';
$url_nav=$GLOBALS["app_route"].'/ajaxview/htmlMapasNav.php';;
$tab='mapas';
...
//    $html.= '</td>';
    ...
    if ($paginaactual < $paginas) {
        ...
        $style_fin = 'class="app_navlink" title="Fin" onclick="loadBDResults(\''.($tamano-$modulo_pag).'\',\'' . $elemPaginas . '\', \'' . $url_content. '\',\'' . $url_nav. '\',\'' . $tab. '\');"';
        $tipo_imagen_fin='';
    }
