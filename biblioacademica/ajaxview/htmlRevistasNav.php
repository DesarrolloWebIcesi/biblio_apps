...
session_start();
$url_content = $GLOBALS["app_route"].'/ajaxview/htmlRevistas.php';
$url_nav=$GLOBALS["app_route"].'/ajaxview/htmlRevistasNav.php';;
$tab='revistas';
...
echo HTMLNavegacionRevistas($cont, $paginas, $size, $tamano, $url_content, $url_nav, $tab);
 ...
 */
function HTMLNavegacionRevistas($cont, $paginas, $elemPaginas, $tamano, $url_content, $url_nav, $tab) {
    $html = '';
    if ($tamano <= 0) {
        $html = '-';
        return $html;
