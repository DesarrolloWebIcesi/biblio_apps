 ...
 * @since 15/10/10
 */
include_once '../control/ControlBusquedaAudio.php';
include_once ('../../commons/services/GeneralServices.php');
include_once ('../Config.php');

session_start();
$url_content = $GLOBALS["app_route"].'/ajaxview/htmlAudio.php';
$url_nav=$GLOBALS["app_route"].'/ajaxview/htmlAudioNav.php';;
$tab='sonoteca';
...
$controlBusqueda = $_SESSION['baaudiosearcher'];
if ($controlBusqueda == null || $controlBusqueda == '') {
    $controlBusqueda = new ControlBusquedaAudio();
    $_SESSION["baaudiosearcher"] = $controlBusqueda;
}
