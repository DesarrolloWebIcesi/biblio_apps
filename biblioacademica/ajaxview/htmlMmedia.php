...
if ($newsearch == 's') {
    $controlBusqueda->cargarSearchMmedia(0, $area);
}
...
/* fin */
echo HTMLResultadosMmedia($tamano, $elementos, $area);
...
function HTMLResultadosMmedia($tamano, $elementos, $keyword) {
    ...
    if ($tamano <= 0) {        
        $html.= '<br/><br/>';
        $html.= '<span class="noelements">No existen m&aacute;s elementos por mostrar</span>';
        return $html;
    }
