...
session_start();
$url_content = $GLOBALS["app_route"].'/ajaxview/htmlBD.php';
$url_nav=$GLOBALS["app_route"].'/ajaxview/htmlBDNav.php';;
$tab='bdatos';
...
echo HTMLNavegacionBD($cont, $paginas, $size, $tamano, $url_content, $url_nav, $tab);
 ...
 */
function HTMLNavegacionBD($cont, $paginas, $elemPaginas, $tamano, $url_content, $url_nav, $tab) {
    $html = '';
    if ($tamano <= 0) {
        $html = '-';
        return $html;
...
//        }
//        if ($numpag <= ($paginas)) {
//            $html.= '<td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a class="app_navlink' . $claseactual . '" onclick="loadBDResults(\'' . ($i * $elemPaginas) . '\',\'' . $elemPaginas . '\', \'n\',\'' . $url_content. '\',\'' . $url_nav. '\',\'' . $tab. '\');">' . $numpag . '</a></font></td>';
//        }
//    }
//    $html.= '</tr></table>';
//    $html.= '</td>';
