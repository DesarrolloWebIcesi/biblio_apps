...
class ControlBusquedaMmedia {
     ...
     * @since 23/12/10
     *
     * @param string $pArea area en la que se desea hacer la búsqueda
     */
    public function cargarSearchMmedia($cont, $pArea) {
        //exit;
        $file = '../lib/.config';
        ...
        while ($bd->siguienteFila($idConsulta)) {
            ...
            if ($imagen != null && $imagen != "null") {
                ...
                $emmedia->setImagen($GLOBALS["biblio_apps"].'/commons/images/no_mediaimage.png');
            }
            $elementos[] = $emmedia;
        }
