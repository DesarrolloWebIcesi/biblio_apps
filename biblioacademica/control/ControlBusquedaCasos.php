...
class ControlBusquedaCasos {
     ...
     * @since 24/11/10
     *
     * @param string $pArea área en la que se desea hacer la búsqueda
     */
    public function cargarSearchCasos($cont, $pArea) {
        //exit;
        $file = '../lib/.config';
        ...
        while ($bd->siguienteFila($idConsulta)) {
            ...
            if ($imagen != null && $imagen != "null") {
                ...
                $caso->setImagen($GLOBALS["biblio_apps"].'/commons/images/no_caseimage.png');
            }
            $elementos[] = $caso;
        }
