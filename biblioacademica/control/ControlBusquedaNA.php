...
class ControlBusquedaNA {
    ...
    public function cargarSearchNA($cont, $idArea) {
        ...
        $idConsulta = 0;
        /* $sql = "select t.titleno, t.title titulo, decode(fbibbus_autores(t.titleno),null,'',fbibbus_autores(t.titleno)) autores, c.shelfmark, c.barcode
