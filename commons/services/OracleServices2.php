 ...
 * @since 22/10/10
 * @version $Id: OracleServices.php 02 Se modificó la clase para que recibiera el puerto de conexión por parametro en un archivo de configuración
 * @since 2012-08-02
 */
class OracleServices {
    ...
    private $host;
    /**
     * @var $port Puerto a través del cual conectarse a la base de datos
     */
    private $port;
    /**
    ...
    private function setDatosConexion($connectionFile) {        
        ...
        $this->port = substr($fileData[4], 0, strlen($fileData[4]) - 2);
    ...
    //Estas funiones fueron heredades de  la anterior clase de conexion a oracle pero no han sido
