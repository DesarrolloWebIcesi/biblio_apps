...
/**
 * Esta archivo genera el HTML necesario para el despliegue de los resultados de una búsqueda elementos
 * de la videoteca.
 *
...
/* fin */
$controlBusqueda = $_SESSION['videosearcher'];
if ($controlBusqueda == null || $controlBusqueda == '') {
    $controlBusqueda = new ControlBusquedaVideos();
    $_SESSION["videosearcher"] = $controlBusqueda;
}

if ($newsearch == 's') {
    $controlBusqueda->cargarSearchVideos(0, $pkeyword);
}
...
/* fin */
echo HTMLResultadosVideos($tamano, $elementos, $pkeyword);
 ...
 */
function HTMLResultadosVideos($tamano, $elementos, $keyword) {
    ...
    if ($tamano <= 0) {
        ...
        $html.= '<div class="subtitulo">Resultados de elementos de audio ' . $mensaje . '</div>';
    }
