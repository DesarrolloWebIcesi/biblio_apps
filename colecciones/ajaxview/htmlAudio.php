...
/* fin */
$controlBusqueda = $_SESSION['audiosearcher'];
if ($controlBusqueda == null || $controlBusqueda == '') {
    $controlBusqueda = new ControlBusquedaAudio();
    $_SESSION["audiosearcher"] = $controlBusqueda;
}

if ($newsearch == 's') {
    $controlBusqueda->cargarSearchAudio(0, $pkeyword);
}
...
/* fin */
echo HTMLResultadosAudio($tamano, $elementos, $pkeyword);
 ...
 */
function HTMLResultadosAudio($tamano, $elementos, $keyword) {
