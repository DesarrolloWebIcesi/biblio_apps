 ...
 * @version 2.1 2013-04-05 damanzano 
 * Se creó la verisón 1.1 de la función cargarAreasAdq().
 */
...
class ControlListasDesplegables {
    ...
    /**
     * Carga y retorna el listado de áreas que muestran en el buscador de nuevas adquisiciones.
     * 
     * @author damanzano
     * @since 2013-04-05 Documented.
     */
    ...
    /**
     * Este método carga el listado de áreas para las cuales se hacen consultas 
