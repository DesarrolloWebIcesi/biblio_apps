...
class ControlBusquedaVideos {
     ...
     */
    public function cargarSearchVideos($cont, $pkeyword) {
        //exit;
        $file = '../lib/.config';
        ...
        $sql = "SELECT t.titleno, t.title, SUBSTR (fbibus_bibliografiaxtitulo (t.titleno), 1, 2000) biblio, t.abstract, o.locator imagen
                ...
                AND (LOWER (t.n_title) LIKE ('%' || LOWER ('".$pkeyword."') || '%')
                    ...
                    OR LOWER (fbibus_bibliografia (t.titleno)) LIKE ('%' || LOWER ('".$pkeyword."') || '%')
        ...
        while ($bd->siguienteFila($idConsulta)) {
            ...
            if ($imagen != null && $imagen != "null") {
                ...
                $video->setImagen($GLOBALS["app_route"].'/images/no_videoimage.png');
            }
            $elementos[] = $video;
        }
