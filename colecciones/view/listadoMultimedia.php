<?php
/**
 * Página de inicio de la colección Multimedia
 *
 * @author damanzano
 * @since 23/11/10
 */
...
<script type="text/javascript" src="<?php echo $GLOBALS["app_route"] ?>/js/lmmedia_validations.js" charset="iso-8859-1"></script>
<div id="biblio_apps">
    <div class="title"></div>
    <div id="app_info">
        <span>
            Digita en el campo T&iacute;tulo , el nombre del elemento multimedia que deseas buscar.
            Si dejas el campo vac&iacute;o se mostrar&aacute; el listado completo de elementos multimedia registrados en el sistema de biblioteca
        </span>
    </div>
    <div id="app_form">
        <form action="" method="post" id="mmediaForm">
                <span></span>
