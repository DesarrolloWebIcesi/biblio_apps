...
<script type="text/javascript" src="<?php echo $GLOBALS["app_route"] ?>/js/lcasos_validations.js" charset="iso-8859-1"></script>
<div id="biblio_apps">
    <div class="title"></div>
    <div id="app_info">
        <span>
            Digita en el campo T&iacute;tulo , el nombre del caso de estudio que deseas buscar.
            Si dejas el campo vac&iacute;o se mostrar&aacute; el listado completo de casos de estudio registrados en el sistema de biblioteca
        </span>
    </div>
    <div id="app_form">
        <form action="" method="post" id="casosForm">
                <span></span>
