<?php
/**
 * Página de inicio de la colección de Mapas
 *
 * @author damanzano
 * @since 23/11/10
 */
...
<script type="text/javascript" src="<?php echo $GLOBALS["app_route"] ?>/js/lmapas_validations.js" charset="iso-8859-1"></script>
<div id="biblio_apps">
    <div class="title"></div>
    <div id="app_info">
        <span>
            Digita en el campo T&iacute;tulo , el nombre del mapa que desees consultar.
            Si dejas el campo vac&iacute;o se mostrar&aacute; el listado completo mapas registrados en el sistema de biblioteca
        </span>
    </div>
    <div id="app_form">
